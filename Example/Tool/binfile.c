...
int main()
{
    ...
    char infile[1024] =
        "/media/zhuhang/D/Data/PPPRTK_INS-Wuh-220519/220520-test/2test/INS-D/F1760369-2022-05-20-13-45-04.imu";
    ...
    while (!feof(fp_in))
    {
        ...
        {
            fprintf(fp_out, "%.9f %.9f %.9f %.9f %.9f %.9f %.9f %.9f\n", gnss.att, gnss.vngps[0], gnss.vngps[1],
                    gnss.vngps[2], gnss.posgps[0], gnss.posgps[1], gnss.posgps[2], gnss.sec);
        }
    }
